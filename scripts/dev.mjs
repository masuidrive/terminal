...
env.LAN = '1';
// LAN exposure forces auth on; pin a known passcode in dev so iterating
// doesn't require fishing a fresh one out of the log each restart.
env.PASSCODE = env.PASSCODE ?? 'dev';
